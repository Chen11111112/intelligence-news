...
const copy = {
  ...
  common: { loading: '載入中…', back: '返回', save: '儲存', close: '關閉' },
  demo: {
    title: '目前僅開放展示瀏覽',
    body: '因伺服器維護與資源配置考量，目前暫未開啟後端服務。本站現僅供前端內容瀏覽與展示，登入後之資料儲存、新聞更新及 AI 對話等互動功能暫時無法使用。',
    contact: '若有特殊需求，想進一步體驗完整功能，歡迎與陳泓毓聯繫。',
    contactAction: '聯繫陳泓毓',
    screenshots: '瀏覽實際操作截圖',
    dismiss: '我知道了',
  },
  ai: {
  ...
  profile: {
    ...
    overviewExam: '英文程度',
    overviewAi: '今日 AI 用量',
    overviewAiUnit: '{used}/{limit} 篇',
    overviewAiLeft: '尚餘 {left} 篇',
    overviewAiFull: '今日額度已用完',
    overviewTapEdit: '點擊修改',
    overviewAiReadonly: '僅供檢視',
    tags: '新聞分類偏好',
